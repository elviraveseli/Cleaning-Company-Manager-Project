...
// Contract Signature (Public Route)
...
import { InvoicePaymentComponent } from './components/invoices/invoice-payment/invoice-payment.component';
...
const routes: Routes = [
  ...
  // Contract signature (public route - no auth required)
  { path: 'contracts/:id/sign', component: ContractSignatureComponent },
