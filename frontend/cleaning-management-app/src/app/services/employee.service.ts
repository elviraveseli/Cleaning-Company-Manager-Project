...
export class EmployeeService {
  ...
  readonly availableSkills = [
    'Pastrimi i Përgjithshëm', // General Cleaning
    'Pastrimi i Dyshemeve', // Floor Care
    'Pastrimi i Dritareve', // Window Cleaning
    'Pastrimi i Tepihëve', // Carpet Cleaning
    'Pastrimi me Presion', // Pressure Washing
    'Pastrimi i Thellë', // Deep Cleaning
    'Dezinfektimi', // Sanitization
    'Përdorimi i Pajisjeve', // Equipment Operation
    'Udhëheqja e Ekipit', // Team Leadership
    'Shërbimi ndaj Klientit', // Customer Service
  ];
